...
from auto_parking.app.schemas.trip_track import TripTrackGroupOut
from auto_parking.app.schemas.vehicle import VehicleOut
from auto_parking.app.schemas.vehicle_track import (
    GeoJSONFeature,
