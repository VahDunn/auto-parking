...
def make_track_points() -> list[VehicleTrackPointModel]:
    return [
        VehicleTrackPointModel(
            id=1,
            trip_id=None,
            recorded_at_utc=datetime(2026, 4, 10, 8, 0, tzinfo=UTC),
...
def make_geojson_track() -> GeoJSONFeatureCollectionModel:
